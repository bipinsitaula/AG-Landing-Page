      ...
      {selected && (
        <div className="fixed inset-0 z-50 bg-gray-900/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setSelected(null)}>
          <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl relative" onClick={e => e.stopPropagation()}>
            ...
            <div className="w-14 h-14 bg-gray-100 text-orange-500 rounded-2xl flex items-center justify-center text-2xl mb-5 mx-auto">
              <i className="fa-solid fa-store"></i>
            </div>
            <h3 className="text-2xl font-extrabold text-black mb-6 text-center">{selected} Branch</h3>
            <div className="space-y-4 text-gray-600 bg-white p-5 rounded-2xl border border-gray-100">
              ...
              <p className="flex items-center">
                ...
                <span className="font-bold text-black">{branchDetails[selected]?.phone}</span>
              </p>
              <p className="flex items-center">
